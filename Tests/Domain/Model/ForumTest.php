...
/**
 * Testcase for class Tx_T3ugForum_Domain_Model_Forum.
 *
 * @version $Id$
 ...
 */
class Tx_T3ugForum_Domain_Model_ForumTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_T3ugForum_Domain_Model_Forum
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_T3ugForum_Domain_Model_Forum();
	}
	 ...
	 * @test
	 */
	public function getTopicsReturnsInitialValueForObjectStorageContainingTx_T3ugForum_Domain_Model_Topic() { 
	 ...
	 * @test
	 */
	public function setTopicsForObjectStorageContainingTx_T3ugForum_Domain_Model_TopicSetsTopics() { 
		$topic = new Tx_T3ugForum_Domain_Model_Topic();
