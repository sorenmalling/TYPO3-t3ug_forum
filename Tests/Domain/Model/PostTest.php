...
/**
 * Testcase for class Tx_T3ugForum_Domain_Model_Post.
 *
 * @version $Id$
 ...
 */
class Tx_T3ugForum_Domain_Model_PostTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_T3ugForum_Domain_Model_Post
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_T3ugForum_Domain_Model_Post();
	}
